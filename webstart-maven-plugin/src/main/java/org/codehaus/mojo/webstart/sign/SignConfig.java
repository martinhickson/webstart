...
public class SignConfig
{
    ...
    public void init(File workDirectory, boolean verbose, SignTool signTool, SecDispatcher securityDispatcher,
        ...
        // preserve existing arguments if they were set from POM configuration
        if (arguments == null) {
            arguments = new ArrayList<>();
        } else {
            // Create a new list but preserve existing arguments
            List<String> existingArguments = new ArrayList<>(arguments);
            arguments = new ArrayList<>(existingArguments);
        }
    ...
    public JarSignerRequest createSignRequest(File jarToSign, File signedJar)
        ...
        request.setProviderName(getProviderName());
